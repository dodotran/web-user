  ...
  return (
    <Box>
        ...
        <Grid container spacing={5} sx={{ margin: 'auto' }} maxWidth={'70%'}>
          <Grid item xs={12} md={6}>
            <Typography variant="body2" component="p" fontWeight={400} lineHeight={'30px'}>
              ...
              dự tiệc, áo dài công sở, áo dài dạ hội Hizu Dress Up chuyên may đo váy đầm, áo dài, áo dài cách tân, áo
              dài cưới, áo dài dự tiệc, áo dài công sở, áo dài dạ hội theo yêu cầu của khách hàng. Với đội ngũ thiết kế
              chuyên nghiệp, tận tâm và nhiệt huyết, Hizu Dress Up cam kết mang đến cho khách hàng những sản phẩm chất
              lượng, đẹp mắt, giá cả hợp lý.
            </Typography>
          </Grid>
          <Grid item xs={12} md={6}>
            <Typography variant="body2" component="p" fontWeight={400} lineHeight={'30px'}>
      ...
      <Grid spacing={5} container sx={{ margin: 'auto' }} padding={'0 20px'}>
        <Grid item xs={12} md={6}>
          <Image
            src="https://theme.hstatic.net/200000719085/1001100454/14/about01_introduce1_img.jpg?v=155"
            layout="responsive"
            width={767}
            height={480}
            alt=""
      ...
      <Grid spacing={2} container sx={{ margin: 'auto' }} padding={'0 40px'} maxWidth={'100%'}>
        ...
        >
          <Image
            src="https://theme.hstatic.net/200000719085/1001100454/14/about01_services_1_ico.png?v=155"
            width={50}
            height={50}
            alt=""
          />
